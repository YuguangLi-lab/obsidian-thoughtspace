...
type Row={group:SVGGElement;path:SVGPathElement;hit:SVGPathElement;label?:Caption;labelKey?:string;handles?:SVGGElement;geometry?:string;style?:string;route?:ReturnType<typeof connectionPath>;selected?:boolean;singleSelected?:boolean;unrelated?:boolean;labelSource?:string;handleZoom?:number};
